(define (domain myDomain_chip_xsmall)
...
Boolean
State
Service_imp1 Service_inv_us Service_lit1 Service_pac_cool1 Service_dic1 Service_cre1 Service_qua1 Service_des_us Service_sma_tes1 Service_tes1 Service_pac1 - Service
)
(:predicates 
