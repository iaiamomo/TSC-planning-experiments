(define (domain myDomain_motor_small)
...
Boolean
State
Service_ass1 Service_inv_us Service_tes1 Service_sma_tes1 Service_pain1 Service_run1 Service_inv_ru Service_run2 Service_inv_ch Service_inv_uk - Service
)
(:predicates 
