(define (domain myDomain_ceramic_xsmall)
...
Boolean
State
Service_fbak1 Service_dry1 Service_mou1 Service_pain1 Service_enam1 Service_pro1 Service_sbak1 Service_shi1 - Service
)
(:predicates 
